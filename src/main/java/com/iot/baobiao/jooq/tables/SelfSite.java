...
public class SelfSite extends TableImpl<SelfSiteRecord> {
     ...
     */
    public final TableField<SelfSiteRecord, LocalDateTime> FETCH_TIME = createField("fetch_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "ץȡʱ", new TimestampToLocalDateTimeConverter());
