...
public class User extends TableImpl<UserRecord> {
     ...
     */
    public final TableField<UserRecord, String> USERNAME = createField("username", org.jooq.impl.SQLDataType.VARCHAR.length(32), this, "");
    ...
    /**
     * The column <code>nutch.user.salt</code>.
     */
    public final TableField<UserRecord, String> SALT = createField("salt", org.jooq.impl.SQLDataType.VARCHAR.length(100), this, "");

    /**
     * The column <code>nutch.user.vip</code>.
     */
    public final TableField<UserRecord, Integer> VIP = createField("vip", org.jooq.impl.SQLDataType.INTEGER, this, "");
