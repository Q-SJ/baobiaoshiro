...
public class UserSite extends TableImpl<UserSiteRecord> {
    ...
    private static final long serialVersionUID = -19231601;
    ...
    public List<UniqueKey<UserSiteRecord>> getKeys() {
        return Arrays.<UniqueKey<UserSiteRecord>>asList(Keys.KEY_USER_SITE_PRIMARY, Keys.KEY_USER_SITE_USER_ID);
    }
