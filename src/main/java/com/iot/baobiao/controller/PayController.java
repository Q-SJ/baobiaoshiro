...
//        String notify_url = "http://120.25.162.238:8080/" + context.getContextPath() +
        ...
        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
                ...
                .setNotifyUrl("http://120.25.162.238:8080/baobiaoshiro/pay/notify");//支付宝服务器主动通知商户服务器里指定的页面http路径,根据需要设置
//                .setGoodsDetailList(goodsDetailList);
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                Baobiaoorder order = new Baobiaoorder(null, user_id, outTradeNo, "",
...
//            System.out.println("验证签名成功！");
            ...
            if (order.getStatus() == TRADE_SUCCESS) return "success"; //如果订单已经支付成功了，就直接忽略这次通知
